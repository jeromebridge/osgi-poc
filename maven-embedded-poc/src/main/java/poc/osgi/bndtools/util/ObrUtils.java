package poc.osgi.bndtools.util;
...
public class ObrUtils {
   ...
   public static Resource createResource( final File bundleFolder ) {
   ...
   public static Resource createResource( final File bundleFolder, final URI uri ) {
      try {
         ...
         final ResourceImpl result = ( ResourceImpl )new DataModelHelperImpl().createResource( manifest.getMainAttributes() );
         if( result != null ) {
